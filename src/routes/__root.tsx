...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Loot Drop — Real-life loot hunting" },
      {
        name: "description",
        content:
          "Loot Drop turns the real world into a game: find loot, snap proof, earn XP and level up.",
      },
      { name: "author", content: "Loot Drop" },
      { property: "og:title", content: "Loot Drop — Real-life loot hunting" },
      {
